...
namespace _4thIR.Custom.Activities
{
    ...
    public class ImageClassificationFDitBase : FourthIRActivity
    {
        ...
        [LocalizedDisplayName(nameof(Resources.ImageClassificationFDitBase_Path_DisplayName))]
        [LocalizedDescription(nameof(Resources.ImageClassificationFDitBase_Path_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Path { get; set; }

        [LocalizedDisplayName(nameof(Resources.ImageClassificationFDitBase_Label_DisplayName))]
        [LocalizedDescription(nameof(Resources.ImageClassificationFDitBase_Label_Description))]
        ...
        public ImageClassificationFDitBase()
        {
        }
