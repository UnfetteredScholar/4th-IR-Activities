...
namespace ImageClassification.Facebbok.DeitBase
{
    public class ImageClassifierFDeitBase
    {
        ...
        public ImageClassifierFDeitBase(HttpClient client)
        {
            _client = client;
        ...
        public async Task<string> ClassifyImage(string path)
        {
            ...
            try
            {
                using (var formData = new MultipartFormDataContent())
                {
                    ...
                    string requestUri = "https://image-classification-facebook-diet-base.ai-sandbox.4th-ir.io/api/v1/classify";
