...
namespace ImageClassification.Facebbok.DitBase
{
    public class ImageClassifierFDitBase
    {
        ...
        public ImageClassifierFDitBase(HttpClient client)
        {
            _client = client;
        ...
        public async Task<string> ClassifyImage(string path)
        {
            ...
            try
            {
                using (var formData = new MultipartFormDataContent())
                {
                    ...
                    string requestUri = "https://image-classification-microsoft-dit-base.ai-sandbox.4th-ir.io/api/v1/classify";
