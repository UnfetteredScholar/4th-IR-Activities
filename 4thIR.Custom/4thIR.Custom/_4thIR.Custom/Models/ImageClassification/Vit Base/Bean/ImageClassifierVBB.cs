...
namespace ImageClassification.VitBase.Bean
{
    public class ImageClassifierVBB
    {
        ...
        public ImageClassifierVBB(HttpClient client)
        {
            _client = client;
        ...
        public async Task<string> ClassifyImage(string path)
        {
            ...
            try
            {
                using (var formData = new MultipartFormDataContent())
                {
                    ...
                    string requestUri = "https://image-classification-vit-base-bean.ai-sandbox.4th-ir.io/api/v1/classify";
