...
namespace TextGeneration.OpenaiGpt
{
    public class TextGeneratorOG
    {
        ...
        public TextGeneratorOG(HttpClient client)
        {
            _client = client;
            //_client.BaseAddress = new Uri("https://text-generation-openai-gpt.ai-sandbox.4th-ir.io");
        ...
        public async Task<string[]> GenerateText(string sentence)
        {
            ...
            try
            {
                ...
                string requestUri = "https://text-generation-openai-gpt.ai-sandbox.4th-ir.io/api/v1/generate";
