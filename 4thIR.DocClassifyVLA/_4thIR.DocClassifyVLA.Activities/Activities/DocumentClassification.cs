...
namespace _4thIR.DocClassifyVLA.Activities
{
    ...
    public class DocumentClassification : ContinuableAsyncCodeActivity
    {
        ...
        [LocalizedDisplayName(nameof(Resources.DocumentClassification_Path_DisplayName))]
        [LocalizedDescription(nameof(Resources.DocumentClassification_Path_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Path { get; set; }

        [LocalizedDisplayName(nameof(Resources.DocumentClassification_DocumentInfo_DisplayName))]
        [LocalizedDescription(nameof(Resources.DocumentClassification_DocumentInfo_Description))]
        ...
        private async Task<DocumentInfo> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            var res = await _classifier.ClassifyDocument(path);
