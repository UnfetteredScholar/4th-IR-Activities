...
using _4thIR.IClassify.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using ImageClassification.DeitBase;

namespace _4thIR.IClassify.Activities
{
    ...
    {
        private static readonly ImageClassifier _classifier = new ImageClassifier();
