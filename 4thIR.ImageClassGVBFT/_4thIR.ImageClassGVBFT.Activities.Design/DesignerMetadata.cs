...
using _4thIR.ImageClassGVBFT.Activities.Design.Designers;
using _4thIR.ImageClassGVBFT.Activities.Design.Properties;

namespace _4thIR.ImageClassGVBFT.Activities.Design
{
