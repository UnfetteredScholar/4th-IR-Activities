...
using _4thIR.TextGenerateOG.Activities.Design.Designers;
using _4thIR.TextGenerateOG.Activities.Design.Properties;

namespace _4thIR.TextGenerateOG.Activities.Design
{
