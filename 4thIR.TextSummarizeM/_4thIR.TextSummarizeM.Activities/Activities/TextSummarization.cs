...
using _4thIR.TextSummarizeM.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using TextSummarization.Multilingual.m5T;


namespace _4thIR.TextSummarizeM.Activities
{
    ...
    public class TextSummarization : ContinuableAsyncCodeActivity
    {
        ...
        [LocalizedDisplayName(nameof(Resources.TextSummarization_SummarizedText_DisplayName))]
        [LocalizedDescription(nameof(Resources.TextSummarization_SummarizedText_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<string> SummarizedText { get; set; }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            // Outputs
            return (ctx) => {
                SummarizedText.Set(ctx, task.Result);
            };
        }
