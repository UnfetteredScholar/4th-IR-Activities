...
using _4thIR.ImageClassifyCV.Activities.Design.Designers;
using _4thIR.ImageClassifyCV.Activities.Design.Properties;

namespace _4thIR.ImageClassifyCV.Activities.Design
{
