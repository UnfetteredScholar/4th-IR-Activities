...
using _4thIR.ImageClassifyEB1.Activities.Design.Designers;
using _4thIR.ImageClassifyEB1.Activities.Design.Properties;

namespace _4thIR.ImageClassifyEB1.Activities.Design
{
