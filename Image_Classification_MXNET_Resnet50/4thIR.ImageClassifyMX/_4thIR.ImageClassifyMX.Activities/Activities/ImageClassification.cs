...
namespace _4thIR.ImageClassifyMX.Activities
{
    ...
    {
        private static readonly ImageClassifierMXNET classifier = new ImageClassifierMXNET();
        ...
        [LocalizedDisplayName(nameof(Resources.ImageClassification_Labels_DisplayName))]
        [LocalizedDescription(nameof(Resources.ImageClassification_Labels_Description))]
