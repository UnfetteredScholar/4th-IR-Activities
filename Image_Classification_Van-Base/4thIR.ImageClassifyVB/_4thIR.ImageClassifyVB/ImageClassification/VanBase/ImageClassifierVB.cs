...
namespace ImageClassification.VanBase
{
    public class ImageClassifierVB
    {
        ...
        public ImageClassifierVB()
        {
            _client.BaseAddress = new Uri("https://image-classification-van-base.ai-sandbox.4th-ir.io");
