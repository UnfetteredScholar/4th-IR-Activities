...
using _4thIR.ImageClassifyVB.Activities.Design.Designers;
using _4thIR.ImageClassifyVB.Activities.Design.Properties;

namespace _4thIR.ImageClassifyVB.Activities.Design
{
