...
using _4thIR.NERecognizeF.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using NameEntityRecognition.Fairseq;

namespace _4thIR.NERecognizeF.Activities
{
    ...
    public class NameEntityRecognition : ContinuableAsyncCodeActivity
    {
        ...
        private static readonly NameEntityRecognizerFairseq recognizer = new NameEntityRecognizerFairseq();
        ...
        private async Task<TextValuePair[]> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            var res = await recognizer.RecognizeNameEntity(sentence);
