...
using _4thIR.ObjectDetectD2.Activities.Design.Designers;
using _4thIR.ObjectDetectD2.Activities.Design.Properties;

namespace _4thIR.ObjectDetectD2.Activities.Design
{
