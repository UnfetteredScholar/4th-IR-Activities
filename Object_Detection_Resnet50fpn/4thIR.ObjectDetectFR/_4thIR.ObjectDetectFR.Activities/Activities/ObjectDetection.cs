...
using _4thIR.ObjectDetectFR.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using ObjectDetection.FasterRCNN.Resnet50fpn;

namespace _4thIR.ObjectDetectFR.Activities
{
    ...
    {
        private static readonly ObjectDetectorFRC _detector = new ObjectDetectorFRC();
        ...
        private async Task<DetectedObject> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            var res = await _detector.DetectObjects(path);
