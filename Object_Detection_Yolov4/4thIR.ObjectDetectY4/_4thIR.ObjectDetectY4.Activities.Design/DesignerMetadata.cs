...
using _4thIR.ObjectDetectY4.Activities.Design.Designers;
using _4thIR.ObjectDetectY4.Activities.Design.Properties;

namespace _4thIR.ObjectDetectY4.Activities.Design
{
