...
using _4thIR.QAnswerMP.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using QuestionAnswering.MPnetBase.V1;

namespace _4thIR.QAnswerMP.Activities
{
    ...
    {
        private static readonly QuestionAnswererM _questionAnswerer = new QuestionAnswererM();
        ...
        [LocalizedDisplayName(nameof(Resources.QuestionAnswering_Answers_DisplayName))]
        [LocalizedDescription(nameof(Resources.QuestionAnswering_Answers_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<AnswerScorePair[]> Answers { get; set; }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            // Outputs
            return (ctx) => {
                Answers.Set(ctx, task.Result);
            };
        }

        private async Task<AnswerScorePair[]> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
