...
using _4thIR.SAnalyze.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using SentimentAnalysis.GenericDataset;

namespace _4thIR.SAnalyze.Activities
{
    ...
    {
        private static readonly SentimentAnalyzer _analyzer = new SentimentAnalyzer();
        ...
        [LocalizedDisplayName(nameof(Resources.SentimentAnalysis_Text_DisplayName))]
        [LocalizedDescription(nameof(Resources.SentimentAnalysis_Text_Description))]
        ...
        private async Task<string> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            var res = await _analyzer.AnalyzeText(text);
