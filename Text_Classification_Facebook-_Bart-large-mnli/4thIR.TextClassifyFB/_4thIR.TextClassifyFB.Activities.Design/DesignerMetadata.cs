...
using _4thIR.TextClassifyFB.Activities.Design.Designers;
using _4thIR.TextClassifyFB.Activities.Design.Properties;

namespace _4thIR.TextClassifyFB.Activities.Design
{
