...
using _4thIR.TextClassifyVD.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using TextClassification.Valhalla;

namespace _4thIR.TextClassifyVD.Activities
{
    ...
    {
        private static readonly TextClassifierV _classifier = new TextClassifierV();
        ...
        [LocalizedDisplayName(nameof(Resources.TextClassification_Scores_DisplayName))]
        [LocalizedDescription(nameof(Resources.TextClassification_Scores_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<double[]> Scores { get; set; }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            return (ctx) => {
                ...
                Scores.Set(ctx, task.Result.scores);
            };
        }
