...
using _4thIR.TextGeneration.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using TextGeneration.Bloom560m;
using _4thIR.ProcessScope.Activities.Activities;

namespace _4thIR.TextGeneration.Activities
{
    ...
    public class TextGeneration : FourthIRActivity
    {
        #region Properties
        ...
        private async Task<string> ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            TextGeneratorBloom generator = new TextGeneratorBloom(ProcessScope.Activities.ProcessScope.GetHttpClient());
